...
Gem::Specification.new('htx', version) do |spec|
  ...
  spec.description   = 'HTX is an HTML template system that is simple, lightweight, and fast. This ' \
                       'library is a Ruby implementation of the HTX template compiler--it converts HTX ' \
                       'templates to their compiled JavaScript form.'
